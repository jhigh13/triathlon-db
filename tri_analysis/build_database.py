...
# Get database engine, drop existing tables, and initialize the database
    ...
    start_date = os.environ.get("START_DATE") or datetime.date(2025, 12, 1).strftime("%Y-%m-%d")
    end_date = os.environ.get("END_DATE") or datetime.date(2026, 4, 1).strftime("%Y-%m-%d")
