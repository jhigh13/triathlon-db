...
# Set start_date for testing: May 1, 2025, formatted as "YYYY-MM-DD"
start_date = datetime.date(2025, 6, 1).strftime("%Y-%m-%d")    
...
print(f"Processed {len(event_df)} events and {len(race_results_df)} race results.")
